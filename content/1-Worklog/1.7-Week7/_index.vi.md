...
| --- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------- | --------------- | ----------------------------------------- |
| 2 | **Frontend API Endpoint Configuration:** <br> - Chỉnh sửa các tệp cấu hình môi trường bên trong mã nguồn React+Vite. <br> - Thay thế các local API endpoints bằng AWS Application Load Balancer (ALB) URL (production-ready) của dự án để thống nhất giao tiếp giữa Client-Server. | 01/06/2026 | 01/06/2026 | |
